...
def main():
    ...
    while running:
        ...
        if frame == 1:
            countdown_start(red.x, red.y, blue.x, blue.y, puck.x, puck.y, "freeforall", "freeforall", green.x, green.y, yellow.x, yellow.y)
        if game_reset:
            countdown_start(red.x, red.y, blue.x, blue.y, puck.x, puck.y, "freeforall", "freeforall", green.x, green.y, yellow.x, yellow.y)
            game_reset = False
    pygame.quit()
